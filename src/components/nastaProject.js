    ...
    <main className="container flex flex-col items-center justify-center px-4 mx-auto mt-10">
      ...
      <div className="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
        <div className="order-2 col-span-12 mt-6 mb-6 lg:mt-0 lg:col-span-5 lg:order-1">
          ...
          <p className="ml-12 ">
            I have created this project to just test my HTML, CSS skills and to better understand resposive design.
            <br />
          ...
          <a className='inline-flex items-center gap-2 py-3 mt-12 ml-12 text-xl font-bold text-white transition-all rounded-lg bg-violet-600 px-7 hover:bg-violet-1000' target="_blank" href='https://nasta-shubham.netlify.app/' rel='noopener noreferrer'>View Project
          <svg fill="white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="24px" height="24px">
