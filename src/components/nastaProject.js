    ...
    <main className="container flex flex-col items-center justify-center px-4 mx-auto mt-10">
      ...
      <div className="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
        <div className="order-2 col-span-12 mt-6 mb-6 lg:mt-0 lg:col-span-5 lg:order-1">
          ...
          <a className='inline-flex items-center gap-2 px-4 py-2.5 mt-12 ml-12 text-xl font-medium border-2 border-violet-600 text-violet-600 transition-all rounded-lg hover:bg-violet-600 hover:text-white' target="_blank" href='https://nasta-shubham.netlify.app/' rel='noopener noreferrer'>View Project
