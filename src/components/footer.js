...
export default function Footer() {
    return (
        <footer className="flex flex-col items-center w-full pt-10 mt-20 bg-gray-800">
            <div className="text-4xl font-bold text-white xl:text-5xl">
                Let's get in touch
            </div>
            <a className="inline-block mt-2 text-white underline"
                href="mailto:shubhammourya15081998@gmail.com">shubhammourya15081998@gmail.com</a>
