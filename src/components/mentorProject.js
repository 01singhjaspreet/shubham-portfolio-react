...
export default function MentorProject() {
    ...
    return (
        <main class="container flex flex-col items-center justify-center px-4 mx-auto mt-10">
            <h2 class="w-full text-xl font-bold">Project Overview</h2>
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                <div class="col-span-12 mb-6 lg:col-span-5">
                    ...
                    <div class="flex items-center mt-6">
                        <div class="flex items-center mt-4">
                            ...
                            <h2 class="ml-4 text-lg font-medium">The Goal</h2>
                        </div>
                    </div>
                    <p class="ml-12 ">
                ...
                <div class="col-span-12 lg:col-span-6 lg:col-start-7">
                    <img src="./assets/mentor/25.png" class="w-full rounded" alt="" />
                    <img src="./assets/mentor/26.png" class="w-full mt-4 rounded" alt="" />
                </div>
            </div>
            ...
            <h2 class="w-full mt-12 text-xl font-bold">Affinity Diagram</h2>
            <img src="./assets/mentor/storyBoard/Mentor--affinity-diagram.jpg" alt="" />


            <div class="grid grid-cols-12 gap-2.5 mt-12">
                <div class="col-span-12 lg:col-span-2">
                    <h2 class="w-full text-xl font-bold">User research</h2>
                </div>
                <div class="col-span-12 lg:col-span-9 lg:col-start-4">
                    ...
                    <div class="flex flex-col mt-2">
                        <div class="flex flex-col w-full my-2">
                            <div class="flex items-center">
                                <div class="flex items-center justify-center w-6 h-6 text-white bg-red-500 rounded-full h-">
                                    1
                                </div>
            ...
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                ...
                <div class="col-span-12 lg:col-span-6 lg:col-start-7">
                    <img src="./assets/mentor/6.png" class="w-full rounded" alt="" />
                </div>
            </div>
            <h2 class="w-full mt-12 text-xl font-bold">Sitemap</h2>
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                <div class="col-span-12 lg:col-span-5">
                    <p class="">
            ...
            <h2 class="w-full mt-12 text-xl font-bold">Logo Discription</h2>
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                <div class="col-span-12 lg:col-span-5">
                    <p class="">
                    ...
                    <h2 class="w-full mt-6 text-lg font-semibold">Details</h2>
                    <p class=""><span class="mt-6 font-medium">Category:</span> Tech</p>
                    <p class=""><span class="font-medium">Type:</span> Clip art logo design</p>
                </div>
                <div class="col-span-12 lg:col-span-6 lg:col-start-7">
                    <img src="./assets/mentor/8.png" class="w-full rounded" alt="" />
                </div>
                <div class="grid w-full grid-cols-12 col-span-12 gap-4 mt-4">
                    <img src="./assets/mentor/9.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
                    <img src="./assets/mentor/10.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
                </div>
            </div>

            <h2 class="w-full mt-12 text-xl font-bold">Paper Wireframe</h2>
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                <div class="col-span-12 lg:col-span-5">
                    <p class="">
                ...
                <div class="col-span-12 lg:col-span-6 lg:col-start-7">
                    <img src="./assets/mentor/11.png" class="w-full rounded" alt="" />
                </div>
            </div>
            <h2 class="w-full mt-12 text-xl font-bold">Paper wireframe
            ...
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                ...
                <div class="col-span-12 lg:col-span-6 lg:col-start-7">
                    <img src="./assets/mentor/12.png" class="w-full rounded" alt="" />
                </div>
            </div>

            <h2 class="w-full mt-12 text-xl font-bold">Digital wireframes
            </h2>
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                <div class="col-span-12 lg:col-span-5">
                    <p class="">
                ...
                <div class="col-span-12 lg:col-span-6 lg:col-start-7">
                    <img src="./assets/mentor/13.png" class="w-full rounded" alt="" />
                </div>
            </div>

            <h2 class="w-full mt-12 text-xl font-bold">Digital wireframe
                screen size variation(s)
            </h2>
            <div class="grid w-full grid-cols-12 gap-4 mt-4">
                <img src="./assets/mentor/14.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
                <img src="./assets/mentor/15.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
            </div>

            <h2 class="w-full mt-12 text-xl font-bold">Low-fidelity prototype
            </h2>
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                <div class="col-span-12 lg:col-span-5">
                    <p class="">
                ...
                <div class="col-span-12 lg:col-span-6 lg:col-start-7">
                    <img src="./assets/mentor/16.png" class="w-full rounded" alt="" />
                </div>
            </div>

            <h2 class="w-full mt-12 text-xl font-bold">Usability study: parameters
            </h2>
            <div class="grid w-full grid-cols-12 gap-4 mt-6">
                <div class="flex flex-col items-center col-span-12 px-4 py-10 shadow-lg rounded-lg md:col-span-6 xl:col-span-3">
                    ...
                    <h2 class="w-full mt-4 text-lg font-medium text-center">Study type:
                    </h2>
                    <p class="w-full mt-4 text-center ">Unmoderated usability study
                    </p>
                </div>
                <div class="flex flex-col items-center col-span-12 px-4 py-10 shadow-lg rounded-lg md:col-span-6 xl:col-span-3">
                    ...
                    <h2 class="w-full mt-4 text-lg font-medium text-center">Location:
                    </h2>
                    <p class="w-full mt-4 text-center ">Hyderabad, India, remote
                    </p>
                </div>
                <div class="flex flex-col items-center col-span-12 px-4 py-10 shadow-lg rounded-lg md:col-span-6 xl:col-span-3">
                    <svg width="41" height="40" viewBox="0 0 41 40" fill="none" >
                    ...
                    <h2 class="w-full mt-4 text-lg font-medium text-center">Participants:
                    </h2>
                    <p class="w-full mt-4 text-center ">5 participants
                ...
                <div class="flex flex-col items-center col-span-12 px-4 py-10 shadow-lg rounded-lg md:col-span-6 xl:col-span-3">
                    ...
                    <h2 class="w-full mt-4 text-lg font-medium text-center">Length:
                    </h2>
                    <p class="w-full mt-4 text-center ">20-30 minutes
                    </p>
                </div>
            </div>
            ...
            <div class="grid w-full grid-cols-12 gap-4 mt-4">
                ...
                <img src="./assets/mentor/18.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
            </div>
            ...
            <div class="grid w-full grid-cols-12 gap-4 mt-4">
                ...
                <img src="./assets/mentor/20.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
            </div>

            <h2 class="w-full mt-12 text-xl font-bold">Mockups: Original screen size
            </h2>
            <div class="grid w-full grid-cols-12 gap-4 mt-4">
                <img src="./assets/mentor/21.png"
                    class="object-cover object-center w-full h-full col-span-12 rounded lg:col-span-6" alt="" />
                <img src="./assets/mentor/22.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
            </div>
            <div class="grid w-full grid-cols-12 gap-4 mt-4">
                <img src="./assets/mentor/1.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
                <img src="./assets/mentor/24.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
            </div>

            <h2 class="w-full mt-12 text-xl font-bold">Mockups: Screen size variations</h2>
            <div class="grid w-full grid-cols-12 gap-4 mt-4">
                <img src="./assets/mentor/2.png" class="w-full h-full col-span-12 rounded lg:col-span-6" alt="" />
                <img src="./assets/mentor/26.png" class="w-full col-span-12 rounded lg:col-span-6" alt="" />
            </div>


            <h2 class="w-full mt-12 text-xl font-bold">High-fidelity prototype</h2>
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                <div class="col-span-12 lg:col-span-5">
                    <p class="">
                ...
                <div class="col-span-12 lg:col-span-6 lg:col-start-7">
                    <img src="./assets/mentor/27.png" class="w-full rounded" alt="" />
                </div>
            </div>
            <div class="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                <div class="col-span-12 lg:col-span-5">
                ...
                <div class="col-span-12 lg:col-span-6 lg:col-start-7">
                    <img src="./assets/mentor/28.png" class="w-full rounded" alt="" />
                </div>
            </div>

            <h2 class="w-full mt-12 text-xl font-bold">Accessibility considerations</h2>
            <div class="grid w-full grid-cols-12 gap-4 mt-6">
                <div class="flex flex-col items-center col-span-12 px-6 py-10 shadow-lg rounded-lg lg:px-10 md:col-span-4">
                    <svg width="52" height="52" viewBox="0 0 52 52" fill="none" >
                        <circle cx="26" cy="26" r="26" class="fill-gray-800" />
            ...
            <h2 class="w-full mt-12 text-xl font-bold">Takeaways</h2>
            <div class="grid w-full grid-cols-12 gap-4 mt-6">
                <div class="flex flex-col items-center col-span-12 px-4 py-10 shadow-lg rounded-lg md:col-span-6 xl:col-span-3">
                    <svg width="42" height="40" viewBox="0 0 42 40" fill="none" >
                        <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <h2 class="w-full mt-4 text-lg font-medium text-center">Impact: Resposive Website </h2>
            ...
            <h2 class="w-full mt-12 text-xl font-bold">Next Steps</h2>
            <div class="grid w-full grid-cols-12 gap-4 mt-6">
                <div class="flex flex-col items-center col-span-12 px-4 py-10 shadow-lg rounded-lg md:col-span-6 xl:col-span-3">
