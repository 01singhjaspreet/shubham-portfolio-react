...
export default function MentorProject() {
  ...
  return (
    <main className="container flex flex-col items-center justify-center px-4 mx-auto mt-10">
      ...
      <h4 className="w-full mt-4 "><span className="font-medium">Scenario :</span> An app to help users to take mentorship from industry experts
      </h4>
      ...
      <div className="grid w-full grid-cols-12 gap-4 mt-6">
        <div className="flex flex-col items-center col-span-12 px-6 py-10 rounded-lg shadow-lg lg:px-10 md:col-span-4">
          <svg width="40" height="40" viewBox="0 0 52 52" fill="none" >
            <circle cx="26" cy="26" r="26" fill='#5F6368' />
        ...
        <div className="flex flex-col items-center col-span-12 px-6 py-10 rounded-lg shadow-lg lg:px-10 md:col-span-4">
          ...
          <p className="w-full mt-4 text-center md:text-justify">Used detailed imagery for mentorship
