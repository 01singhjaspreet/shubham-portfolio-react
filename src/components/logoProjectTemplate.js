        ...
        >
            ...
            <div className="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
                <div className="order-2 col-span-12 lg:col-span-5 lg:order-1">
                    ...
                    {url &&
                        <a className='inline-flex items-center gap-2 py-3 mt-12 text-xl font-bold text-white transition-all rounded-lg bg-violet-600 px-7 hover:bg-violet-1000' target="_blank" href={url} rel='noopener noreferrer'>View Website
