    ...
    >
      ...
      <div className="grid grid-cols-12 gap-2.5 mt-6 w-full text-gray-700">
        <div className="order-2 col-span-12 lg:col-span-5 lg:order-1">
          ...
          {url &&
            <a className='inline-flex items-center gap-2 px-3 py-2 mt-12 text-lg font-medium transition-all border-2 rounded-lg border-violet-600 text-violet-600 hover:bg-violet-600 hover:text-white' target="_blank" href={url} rel='noopener noreferrer'>View Website
