    ...
    <>
      ...
      <section class="bg-slate-100 w-screen">
        <div className='container flex justify-between mx-auto'>
          <div className='flex flex-col justify-center'>
            <h2 class="text-4xl font-bold mb-6">UX / UI DESIGNER</h2>
            <div class="text-xl max-w-xl font-medium">
              Hello! I'm Shubham, a multifaceted creative with 4 years of experience in UX & UI.
              <br />
            </div>
          </div>
          <img src={DP} loading="lazy" alt="Shubham Mourya" class="w-72" />
        </div>
      </section>
      <section class="bg-violet-700 py-10 w-screen">
        <div class="container mx-auto ">
          <div class="w-full flex justify-between">
            <h2 class="text-4xl font-bold mb-6 text-white">SKILLSET</h2>
            <div className='flex justify-end'>
              <Link href={Resume} target="_blank"
                className="px-4 text-xl font-bold bg-white !leading-none flex justify-center items-center h-12">
                VIEW RESUME
              </Link>
            </div>
          </div>
          <div class="grid grid-cols-12 gap-20">
            <div className='col-span-4'>
              <h3 class="text-lg font-bold text-white pb-2.5 my-5 border-b border-[#ffffff73]">BREADTH</h3>
              <div class="flex flex-wrap gap-2">
                <div class="inline-block rounded-lg text-white text-sm bg-gray-900 px-2.5 py-1.5">Information architecture</div>
                <div class="inline-block rounded-lg text-white text-sm bg-gray-900 px-2.5 py-1.5">Interaction design</div>
                <div class="inline-block rounded-lg text-white text-sm bg-gray-900 px-2.5 py-1.5">Prototyping</div>
                <div class="inline-block rounded-lg text-white text-sm bg-gray-900 px-2.5 py-1.5">Visual design</div>
                <div class="inline-block rounded-lg text-white text-sm bg-gray-900 px-2.5 py-1.5">HTML /CSS</div>
                <div class="inline-block rounded-lg text-white text-sm bg-gray-900 px-2.5 py-1.5">Illustration</div>
                <div class="inline-block rounded-lg text-white text-sm bg-gray-900 px-2.5 py-1.5">Animation</div>
              </div>
            </div>
            <div className='col-span-8'>
              <h3 class="text-lg font-bold text-white pb-2.5 my-5 border-b border-[#ffffff73]">DEPTH</h3>
              <div class="flex justify-between">
                <div class="div-block">
                  <svg class="h-36 fill-gray-900" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160.69 150">
                  ...
                  <h4 class="text-lg text-white mt-4 font-medium">Design systems</h4>
                </div>
                <div class="div-block">
                  <svg class="h-36 fill-gray-900" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 225.06 150">
                    <g id="Layer_1-2" data-name="Layer 1">
                      <g>
                  ...
                  <h4 class="text-lg text-white mt-4 font-medium">Responsive UI</h4>
                </div>
                <div class="div-block">
                  <svg class="h-36 fill-gray-900" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150">
                    <g id="Layer_1-2" data-name="Layer 1">
                      <g>
                  ...
                  <h4 class="text-lg text-white mt-4 font-medium">Accessible Design</h4>
                </div>
              </div>
            </div>
          </div>
      ...
      <section class="bg-slate-100 w-screen">
        <div class="container mx-auto py-10">
          <h2 class="text-4xl font-bold mb-10">TOOLBOX</h2>
          <div class="flex justify-between">
            <img src={photoshop} className='w-40' loading="lazy" alt="Adobe Photoshop" />
            <img src={illustrator} className='w-40' loading="lazy" alt="Adobe Illustrator" />
            <img src={figma} className='w-40' loading="lazy" alt="Figma" />
            <img src={vscode} className='w-40' loading="lazy" alt="Visual Studio Code" />
          </div>
        </div>
      </section>
      <Footer />
