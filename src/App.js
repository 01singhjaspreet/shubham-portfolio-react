  ...
  return (
    <>
      ...
      <section class="bg-violet-700 w-screen">
        <div className='flex flex-col-reverse items-center justify-between max-w-5xl px-4 mx-auto'>
          <div className='flex flex-col justify-center'>
            <h2 class="text-2xl md:text-4xl font-bold mb-6 text-white  text-center sm:text-left">UX / UI DESIGNER</h2>
            <p class=" max-w-xl font-medium text-white text-base md:text-xl pb-5 sm:pb-0">
        ...
        <Link href={Resume} target="_blank"
          className="px-4 flex md:hidden text-base md:text-xl w-[fit-content] font-semibold bg-white hover:bg-slate-100 transition-all focus:bg-slate-100 mb-8 mx-4 !leading-none  justify-center items-center h-10 md:h-12">
          VIEW RESUME
        </Link>
      </section>
      <section class="bg-slate-100 py-10 w-screen max-w-5xl mx-auto px-4 ring-slate-100 ring-1">
        ...
        <div class="grid grid-cols-12 gap-4 md:gap-20 w-full overflow-hidden">
          <div className='col-span-12 md:col-span-4'>
            <h3 class="text-lg font-bold pb-2.5 my-5 border-b border-gray-700">BREADTH</h3>
            <div class="flex flex-wrap gap-2 w-[calc(100vw-32px)]">
          ...
          <div className='col-span-12 md:col-span-8'>
            ...
            <div class="flex justify-between gap-4 flex-col md:flex-row w-[calc(100vw-32px)]">
              <div class="flex md:flex-row gap-4 items-center">
                <svg class="w-20 lg:h-36 fill-gray-900" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160.69 150">
              ...
              <div class="flex md:flex-row  gap-4 items-center">
                <svg class="w-20 lg:h-36 fill-gray-900" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 225.06 150">
                  <g id="Layer_1-2" data-name="Layer 1">
                    <g>
              ...
              <div class="flex md:flex-row  gap-4 items-center">
                <svg class="w-20 lg:h-36 fill-gray-900" id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 150 150">
                  <g id="Layer_1-2" data-name="Layer 1">
                    <g>
      ...
      <section class="bg-slate-100 w-screen">
        <div class="max-w-5xl mx-auto py-10 px-4">
          ...
          <div class="flex justify-between ">
            <img src={photoshop} className='w-20 lg:w-40' loading="lazy" alt="Adobe Photoshop" />
            <img src={illustrator} className='w-20 lg:w-40' loading="lazy" alt="Adobe Illustrator" />
            <img src={figma} className='w-20 lg:w-40' loading="lazy" alt="Figma" />
            <img src={vscode} className='w-20 lg:w-40' loading="lazy" alt="Visual Studio Code" />
          </div>
        </div>
      </section>
      <Footer />
